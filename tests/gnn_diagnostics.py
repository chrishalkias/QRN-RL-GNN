...
# def plot_gnn_diagnostics(model_path, n_nodes=4, cutoff_tau_ratio=1, pca_samples=1000, savefig=True):
#     """
...
#     # Plot Policy Preferences Q(Swap) - Q(Entangle)
...
#     # =========================================================================
#     # ============== PLOT 4: Latent Space Visualization (PCA) =================
#     # =========================================================================
...
#         plt.tight_layout()
#         plt.savefig(save_img_dir+ "latent_pca.png") if savefig else None
#         plt.show()
#         plt.close()
#     else:
...
#     plot_gnn_diagnostics(model_path=path, 
#                               n_nodes=4, 
